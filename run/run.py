...
def main():
    ...
    if args.output_file is None:
        if is_test:
            ...
            output_file = f"data/data_raw/{model_name}/{DATASET}_{METHOD}-generated_{NUM_OF_DATA}_{demand_key}_{args.reflection}_{args.use_scratchpad}.jsonl"
    else:
        ...
        output.append(
            {
                ...
                "reason_prompt": agent.reason_prompt_str,
                "reflection_prompt": ""
            }
        )
        s_t=time.time()
                ...
                output.append(
                    {
                        ...
                        "reflection_source": reflect_llm.model_id,
                        "reason_prompt": agent.reason_prompt_str,
                        "reflection_prompt": agent.reflection_prompt_str
                    }
                )
