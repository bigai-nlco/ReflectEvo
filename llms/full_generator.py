...
class FullGenerator(LMGenerator):
    def __init__(self, model_path,tokenizer_path, log_file):
        super().__init__(f'{model_path}', log_file)
        print("!!! FullGenerator init !!!")
        self.LOGGER.info('Load model')
        self.tokenizer = AutoTokenizer.from_pretrained(tokenizer_path)
        self.model = AutoModelForCausalLM.from_pretrained(model_path, device_map="cuda",torch_dtype=torch.bfloat16)
